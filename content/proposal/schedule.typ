...
= Schedule
The thesis starts on April 28, 2024 and ends on October 27, 2024. It is structured into 8 iterations, each lasting 2–4 weeks. Each iteration focuses on a set of measurable and integrated technical deliverables to support the overall objective of developing and validating a scalable architecture for medical imaging. @HighLevelTimeline illustrates the High-level timeline of the thesis with further explanation about the details in the paragraphs below.

#figure(
  image("../../figures/master-thesis-timeline.png"),
  caption: [High-level timeline for the thesis.],
) <HighLevelTimeline>

== Iteration 1: Analyze Existing Technologies and Standards (4 weeks)
*April 28 – May 26, 2024*
- Research medical imaging standards (DICOM, DICOMweb, HL7)
- Analyze architectures for interoperable imaging systems
...
*May 27 – June 9, 2024*
- Define system requirements for second-opinion workflow
...
- Create architectural diagrams and define core components
...
- Enable basic image access through viewer interface
...
- Build components to support image handover, viewing, and routing
...
== Iteration 6: Validation – Pre-Validation Refinement and Review (3 weeks)
*August 26 – September 15, 2024*
- Improve system usability for imaging staff and experts
...
- Ensure the architecture meets compliance, performance, and interoperability targets.
- Conduct final refinements based on feedback and test results.
